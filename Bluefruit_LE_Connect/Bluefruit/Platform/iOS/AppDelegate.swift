...
//
//  Edited on 11/7/2019
//  signified by comment "***EDIT***" beginning changes and "***/EDIT***" ending changes
//  Edits in functions application and applicationDidEnterBackground
//  Copyright © 2019 Kramerica Industries. All rights reserved.
//
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationDidEnterBackground(_ application: UIApplication) {
        ...
        content.title = "Relax App"
        content.subtitle = "You're Stressed Out!"
        content.body = "Just relax and breathe. Time won't go any slower being stressed. And don't hate yourself."
        
        // set notification trigger - sends after 2 seconds, does not repeat
        let trigger = UNTimeIntervalNotificationTrigger(timeInterval: 2.0, repeats: false)
        
        // create notificaation request
